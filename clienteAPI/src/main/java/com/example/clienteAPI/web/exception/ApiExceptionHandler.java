package com.example.clienteAPI.web.exception;
...
import com.example.clienteAPI.exception.CannotDeleteException;
import com.example.clienteAPI.exception.CannotDisableException;
import com.example.clienteAPI.exception.EntityNotFoundException;
import com.example.clienteAPI.exception.NegativeSaldoException;
import com.example.clienteAPI.exception.RequiredCorrentistaException;
import com.example.clienteAPI.exception.RequiredNameException;
import com.example.clienteAPI.exception.RequiredPhoneException;
import com.example.clienteAPI.exception.RequiredSaldoException;
...
//     //Tratamento para erro de validação de argumentos (400 - Bad Request)
...
//	}
    ...
    //Tratamento para erro de comunicação com serviços externos via Feign (500 ou erros HTTP retornados pelo cliente).
    @ExceptionHandler(FeignException.class)
    public ResponseEntity<ErrorMessage> handleFeignException(FeignException ex, HttpServletRequest request) {

        logger.error("Erro Feign Client capturado: {}", ex.getMessage(), ex);
    ...
    //Tratamento genérico para qualquer exceção não tratada anteriormente (500 - Internal Server Error).
